---
title: "Relationships between population change (lambdas) and traits for mammals only"
output:
  html_document:
    toc: true
    toc_float: true
...
-   When modelling summed lambdas, the two top models included System and TrophicLevel (6 top models included trophic level!).
-   When modelling average lambdas, the top model was the null model (according to performance index). The 2nd best included included System and LifeSpan, and the 3rd best included Lifespan and trophic level.
...
```{r}
ggplot(df) +
  geom_point(aes(y = sumlambda, x = log10(LifeSpan), col = System), alpha = .5)

ggplot(df) +
  geom_point(aes(y = sumlambda, x = log10(BodySize), col = System), alpha = .5)
```
...
```{r}
summed_performance <- compare_performance(m0, m1, m2, m3, m4, m5, m6, m7, m8, 
...
# ggsave(here::here("figures/m7_mammals_sumlambda_performance.png"),
#        width = 10, height = 11)
knitr::include_graphics(here::here("figures/m7_mammals_sumlambda_performance.png"))
```

```{r, fig.height=9}
plot_model(m7, type="est")
```
...
# ggsave(here::here("figures/m6_mammals_sumlambda_performance.png"),
#        width = 10, height = 11)
knitr::include_graphics(here::here("figures/m6_mammals_sumlambda_performance.png"))
```
...
### How do the average rates of change vary by lifespan in each system?

```{r, echo = FALSE}
ggplot(df) + geom_point(aes(y = avlambda, x = log10(LifeSpan), col = System))
```

### How do the average rates of change vary by body size in each system?

```{r, echo = FALSE}
ggplot(df) + geom_point(aes(y = avlambda, x = log10(BodySize), col = System))
```
...
```{r}
avg_performance <- compare_performance(m0, m1, m2, m3, m4, m5, m6, m7, m8, 
                                          m9, m10, m11, m12, m13, m14,  
                    rank = TRUE,
                    metrics = "all") 
...
# ggsave(here::here("figures/m0_mammals_avglambda_performance.png"),
#        width = 10, height = 11)
knitr::include_graphics(here::here("figures/m0_mammals_avglambda_performance.png"))
```


#### Model 10: System*LifeSpan
...
# ggsave(here::here("figures/m10_mammals_avglambda_performance.png"),
#        width = 10, height = 11)
knitr::include_graphics(here::here("figures/m10_mammals_avglambda_performance.png"))
```

```{r}
plot_model(m10, type="est")
```

```{r}
plot_model(m10, type="pred")
```


#### Model 13: TrophicLevel + LifeSpan
...
# ggsave(here::here("figures/m13_mammals_avglambda_performance.png"),
#        width = 10, height = 11)
knitr::include_graphics(here::here("figures/m13_mammals_avglambda_performance.png"))
```

```{r}
plot_model(m13, type="est")
```
